    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api SanzyBot - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6281276698054">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Sanzy</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Sanzy" <api.sanzy@gmail.com>',
        to: email,
        subject: `Verify Email - Api Sanzy`,
        html: inboxGmail,
      };
